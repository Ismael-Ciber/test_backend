...
app.get("/imagenes", (req, res) => {
    ...
    const localización = geoip.lookup(ip);
    const insert = db.prepare("INSERT INTO usuarios (ip, userAgent, localización, fecha) VALUES (?, ?, ?, ?)");
    insert.run(ip, userAgent, localización, fecha);
